...
{
    public class BaseRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {

        DbSet<Tbl_Entity> _dbSet;

        private RANKSWHOLESALEEntities _DBEntity;

        public BaseRepository(RANKSWHOLESALEEntities DBEntity)
        {
            _DBEntity = DBEntity;
